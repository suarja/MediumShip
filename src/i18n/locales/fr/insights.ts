export default {
  ...
  invite: {
    kicker: "Premium",
    title: "Ton briefing est prêt",
    body: "On a préparé ton compte rendu de lecture — quelques minutes pour voir où tu en es et quoi lire ensuite.",
    open: "Lire le briefing",
    later: "Plus tard",
  },
} as const;
