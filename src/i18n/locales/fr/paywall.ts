export default {
  ...
  purchaseCtaFallback: "Passer Premium — 2 €/mois",
  ...
  webPurchaseHint:
    "Les achats integres sont disponibles sur l'app iOS et Android. Ouvre l'app sur ton telephone pour t'abonner.",
